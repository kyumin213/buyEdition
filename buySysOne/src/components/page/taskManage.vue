<template>
	<div>
				...
				<el-tab-pane label="全部" name="all">
					<div class="mb20 TypeItems">
						<div>
							...
							<div class="des">很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份 很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份很好打公司股份
							</div>
						</div>
						<div>
		...
		<!-- 创建任务-->
		<el-dialog title="创建任务" :visible.sync="addTaskModal" width="90%" custom-class="fixed-dialog" :close-on-click-modal="false" :before-close="closeModel" top='5vh'>
			<el-row>
      ...
      selectableRange: '00:00:00 - 23:59:00'
							...
							<el-row>
								<el-form-item label='备注'>
									<el-input type='textarea' :autosize="{ minRows: 2, maxRows: 6}" v-model='taskForm.remark'></el-input>
								</el-form-item>
							</el-row>
						</div>
					</el-form>
      ...
      selectableRange: '00:00:00 - 23:59:00'
		...
		<!-- QA任务-->
		<el-dialog title="QA任务" :visible.sync="QAtaskModel" width="70%" :close-on-click-modal="false" top='5vh'>
								...
								<el-row :gutter="20">
									...
									<el-col :span="8" :xs="24">
										<el-form-item :prop="`problemData[${index}].problem`" :rules="[{required: true, message: '请输入问题', trigger: 'change'}]">
											<el-input type="textarea" v-model="item.problem" class="disInline"></el-input>
								...
								<el-row :gutter="20">
									...
									<el-col :span="7" :xs="24">
										<el-form-item :prop="`answerData[${index}].answer`" :rules="{required: true, message: '请输入回答', trigger: 'change'}">
											<el-input type="textarea" v-model="item.answer" class="disInline"></el-input>
										</el-form-item>
									</el-col>
									<el-col :span='6' :xs="24">
										<el-form-item>
