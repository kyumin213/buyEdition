							...
							<el-row :gutter="20">
								...
								<el-col :span="8" :xs="24">
									<el-form-item :prop="`problemData[${index}].problem`" :rules="[{required: true, message: '请输入问题', trigger: 'change'}]">
										<el-input type="textarea" v-model="item.problem" class="disInline wid" placeholder='请输入问题'></el-input>						
									</el-form-item>
								</el-col>
										<el-col :span='6' :xs="24">
										<el-form-item>
			...
			<div class="answer" v-show="QaType === false">
				<div class="con">
					<el-form :model="answerForm" ref="answerForm" status-icon>
							...
							<el-row :gutter="20">
								...
								<el-col :span="6" :xs="24">
									<el-form-item class="wid100" :prop="`answerData[${index}].address`" :rules="{required: true, message: '请输入问题链接', trigger: 'change'}">
										<el-input v-model="item.address" placeholder='请输入问题链接'></el-input>
									</el-form-item>
								</el-col>
								<el-col :span="8" :xs="24">
									<el-form-item :prop="`answerData[${index}].answer`" :rules="{required: true, message: '请输入回答', trigger: 'change'}">
										<el-input type="textarea" v-model="item.answer" class="disInline wid" placeholder='请输入回答'></el-input>
									</el-form-item>
								</el-col>
								<el-col :span='6' :xs="24">
										<el-form-item>
						...
						<el-form-item>
							<el-button type="primary"  @click="answerComfir('answerForm')">确定</el-button>
