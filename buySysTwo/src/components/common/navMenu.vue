  ...
  <div class="navCon">
    <div class="navHead">
      ...
      <div style="width: 80%;" class="navs">
        <el-menu :default-active="onRoutes" background-color="#205081" text-color="#fff"
                 active-text-color="#E6A23C" class="el-menu-demo navBox" mode="horizontal" @select="handleSelect"
                 unique-opened router>
          <el-menu-item index="loginHome"><i class="el-icon-s-home"></i>首页</el-menu-item>
          <el-menu-item index="taskManage"><i class="el-icon-menu"></i>任务管理</el-menu-item>
          <el-menu-item index="accountManage"><i class="el-icon-money"></i>资金管理</el-menu-item>
          <el-menu-item index="help"><i class="el-icon-chat-line-round"></i>帮助中心</el-menu-item>
          <el-submenu index="5" class="userInfoBox">
            <template slot="title"><i class="el-icon-s-custom"></i>{{name}}kyumin</template>
      ...
      <div class="disNone">
        <div>
          <el-menu :default-active="onRoutes" background-color="#205081" text-color="#fff"
                   active-text-color="#E6A23C" class="el-menu-demo" mode="horizontal" @select="handleSelect"
                   unique-opened router>
